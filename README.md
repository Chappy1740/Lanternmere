...
Milestones 0–5 are implemented. Milestone 6, **Adventures & Guild Operations**, is in progress; its delivered foundation provides a Lodge-scoped planning hub built on canonical Quest Board events. See the [Milestone 6 specification](docs/milestones/milestone-06-adventures.md) and status document for the agreed next steps, verification evidence, original-MVP gaps, and remaining coverage limits.
